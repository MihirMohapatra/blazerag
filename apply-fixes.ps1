# Run this from D:\Rust-Project\Blazerag
# Usage: .\apply-fixes.ps1

Set-Location $PSScriptRoot

# Create and switch to new branch
git checkout -b fix/repo-improvements
...
version = "0.1.0"
edition = "2021"
description = "Blazing-fast RAG server written in Rust"
authors = ["Mihir Mohapatra <mihirmohapatra@outlook.com>"]
license = "MIT OR Apache-2.0"
repository = "https://github.com/MihirMohapatra/blazerag"
keywords = ["rag", "llm", "vector-search", "axum", "qdrant"]
...
futures = "0.3"
tokio-stream = "0.1"
# ort 2.0.0-rc.12 is a release candidate; ONNX support is experimental.
# Use --no-default-features to fall back to the HTTP embedder on stable builds.
...
# -- 2. Remove duplicate agent.md ----------------------------------------------
if (Test-Path agent.md) { Remove-Item agent.md }

# -- 3. Create docs/ folder and architecture.md --------------------------------
...
| Server | Integration via HTTP endpoints | [WIP] planned for v0.2.0 |
...
# -- 6. Commit and push --------------------------------------------------------
git add -A
git commit -m "fix: repo improvements across README, Cargo.toml, and docs

- Cargo.toml: fix authors, add license/repository/keywords/categories
- Cargo.toml: flag ort rc as experimental in comment
- README: add Why BlazeRAG section
- README: qualify 5000+ req/s claim as target benchmark
- README: fix QDRANT_URL description (HTTP 6333 vs gRPC 6334)
- README: remove streaming from features (still in roadmap)
- README: mark ONNX as experimental throughout
- README: remove dangling rust-toolchain.toml from project tree
- README: replace email with GitHub Discussions link
- docs/architecture.md: create docs/ folder with component breakdown
- CHANGELOG.md: add with v0.1.0 entry and unreleased section
- agent.md: remove duplicate of AGENTS.md"

git push origin fix/repo-improvements

Write-Host "`n[OK] Done! Branch pushed. Open a PR at:" -ForegroundColor Green
Write-Host "https://github.com/MihirMohapatra/blazerag/compare/fix/repo-improvements" -ForegroundColor Cyan
